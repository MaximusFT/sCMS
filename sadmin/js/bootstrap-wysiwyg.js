...
(function ($) {
	...
	var readFileIntoDataUrl = function (fileInfo,id) {
		var loader = $.Deferred();
         var fd = new FormData();
         var path ="";
		...
		var editor = this,
            ...
            toggleHtmlEdit = function() {
				if ( $(editor).data("wysiwyg-html-mode") !== true ) {
                	...
                	$(editor).html(' ');
                	$('.btnWSave').data('htmlx', false);
                	$(editor).append(document.createTextNode( oContent ));
