...
$columns = array(
    ...
    array('db' => 'name-l', 'dt' => 'full-name',
        'formatter' => function( $d, $row, $table ) {
            $res = $row['name-l'].' '.$row['name-f'].' '.$row['name-s'];
            return $res;
        }
    ),
    array('db' => 'address-street', 'dt' => 'full-address',
        'formatter' => function( $d, $row, $table ) {
    ...
    array('db' => 'name-l', 'dt' => 'full-phone',
        'formatter' => function( $d, $row, $table ) {
            $res = ((!empty($row['phone-home']))?$row['phone-home'].', ':'').
                ((!empty($row['phone-mobile']))?$row['phone-mobile'].', ':'').
                ((!empty($row['phone-second']))?$row['phone-second']:'');
            return $res;
        }
    ),
