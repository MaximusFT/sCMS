        ...
        <tr>
                ...
                <div class="input-group input-group-sm">
                  <a class="btn btn-sm btn-primary contentEdit"
                   ...
                   <span class="input-group-btn">
                        <a class="btn btn-sm btn-primary articleEdit" href="/sadmin/content/<?=$r['id'];?>/">
            ...
            <td>
                <div class="input-group input-group-sm">
                    ...
                    <span class="input-group-btn">
                        <a href="/sadmin/ajax/_row-del.php" class="btn btn-danger RowDel" data-params="content|<?=$r['id'];?>"><span class="glyphicon glyphicon-trash"></span></a>
                    </span>
                </div>
            </td>
        </tr>
