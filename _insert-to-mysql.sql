...
CREATE TABLE `menu` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_parent_id_alias` (`parent_id`,`alias`),
...
-- Records of menu
-- ----------------------------
INSERT INTO `menu` VALUES ('1', '0', '0', '0', 'Root', 'root', '', '', 'none', '1', '', '0', '', '0', '0', '1', '35');
INSERT INTO `menu` VALUES ('2', '1', '1', '1', 'Главная страница', 'home', '/', 'GET', 'mainPageCtrl', '1', '', '1', '', '1', '1', '2', '3');
INSERT INTO `menu` VALUES ('3', '3', '8', '2', 'Карта сайта', 'sitemap', '/sitemap/', 'GET', 'sitemapCtrl', '1', '', '0', '', '1', '1', '4', '5');
INSERT INTO `menu` VALUES ('4', '1', '1', '3', 'Статьи', 'articles', '/articles/', 'GET', 'articlesPageCtrl', '0', '', '0', '', '1', '1', '6', '7');
INSERT INTO `menu` VALUES ('9', '4', '1', '4', 'Подписка', 'subscribe', '/subscribe/', 'POST', 'subscribeCtrl', '1', '', '0', '', '1', '1', '27', '28');
INSERT INTO `menu` VALUES ('10', '2', '1', '5', 'Задать вопрос', 'asking', '/asking/', 'GET', 'askingCtrl', '1', '', '0', '', '1', '1', '31', '32');
INSERT INTO `menu` VALUES ('11', '4', '9', '0', 'Комментарии', 'comment', '/comment/', 'POST', 'commentCtrl', '1', '', '0', '', '1', '1', '13', '14');
INSERT INTO `menu` VALUES ('12', '1', '2', '7', 'Основная первая статья', 'article-1', '/article-1/', 'GET', 'commonPageCtrl', '1', '', '0', '', '1', '2', '7', '8');
INSERT INTO `menu` VALUES ('13', '1', '2', '8', 'Очень интересная и познавательная статья по тематике вашего сайта', 'article-2', '/article-2/', 'GET', 'commonPageCtrl', '1', '', '0', '', '1', '2', '9', '10');
INSERT INTO `menu` VALUES ('14', '1', '2', '9', 'Статья которая раскрывает тематику вашего сайта', 'article-3', '/article-3/', 'GET', 'commonPageCtrl', '1', '', '0', '', '1', '2', '11', '12');
INSERT INTO `menu` VALUES ('15', '1', '2', '10', 'Важные рекомендация для посетителей вашего сайта', 'article-4', '/article-4/', 'GET', 'commonPageCtrl', '1', '', '0', '', '1', '2', '13', '14');
INSERT INTO `menu` VALUES ('19', '1', '1', '14', 'Отменить подписку', 'unsubscribe', '/unsubscribe/', 'GET', 'unsubscribeCtrl', '1', '', '0', '', '1', '1', '29', '30');
INSERT INTO `menu` VALUES ('29', '4', '9', '18', 'Больше статей', 'articles-more', '/articles/more/', 'POST', 'mainPageMoreCtrl', '1', '', '0', '', '1', '1', '33', '34');
INSERT INTO `menu` VALUES ('30', '4', '9', '0', 'Задать вопрос', 'asking-do', '/asking/do/', 'POST', 'askingDoCtrl', '1', '', '0', '', '1', '0', '0', '0');
INSERT INTO `menu` VALUES ('31', '1', '12', '19', 'sitemap.xml', 'sitemap.xml', '/sitemap.xml', 'GET', 'sitemapXMLCtrl', '1', '', '0', '', '1', '0', '0', '0');
